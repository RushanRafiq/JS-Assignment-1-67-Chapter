...
/* Q6 */
var email = "rushan@students.uit.edu"
...
for (i = 0; i < ku.length; i++) { document.write(ku[i]) }
...
Write a custom
function power(a, b) to calculate the value of a raised to b.
...
Write a
function to delete all vowels from a sentence.Assume that the sentence is not more than 25 characters long.
